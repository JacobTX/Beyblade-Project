...
def reset(T_val,name,angle,x,y,z):
...
class Application(tk.Frame):              
    ...
    def launch1(self):
        ...
        reset(T_val,'beyblade::link_0',angle_1,0.0,0.5,1.0)    
    ...
    def launch2(self):
        ...
        reset(T_val_2,'beyblade2::link_0',angle_2,-0.5,0,1.0)
    ...
    def launch3(self):
        ...
        reset(T_val_3,'beyblade3::link_0',angle_3,0.5,0,1.0)
    ...
    def launch4(self):
        ...
        reset(T_val_4,'beyblade4::link_0',angle_4,0.0,-0.5,1.0)
